---
title: "Publication Performance & Data Visualization: <br> How we think about it"
...
##General problems:
- **Bibliometric data** is currently being produced and is available in **huge quantities**.
- Researchers and **department heads don't have the time to monitor it all**.
- To get relevant insight into data about the research landscape, **one must be able to look at multiple research fields at once**; deep insight into one field may cloud one's judgment about others (e.g., science vs humanities OR event in case of Faculty of Arts **e.g. 60101 vs 60102, totally different disciplines**).

##Faculty of Arts solution:
...
- Quarterly reports based on department datasets with newly entered results and information about expected value in IM points.
- Three times per year, data for publication scholarships.
...
.center[
Mgr. et Mgr. Stanislav Hasil, Ph.D. | [Central Library of the Faculty of Arts](https://knihovna.phil.muni.cz/)
]
.center[
...
.center[
<img src="obrazky/qr_knihovna.png" style="width:40%;" alt="https://knihovna.phil.muni.cz/">
]
